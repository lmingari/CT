...
header-includes: | 
    ...
    \titlegraphic{%
        \begin{tikzpicture}[remember picture,overlay]
            \node[anchor=south east] at ([xshift=-10mm, yshift=5mm]current page.south east) {
                \includegraphics[width=50px]{figures/qr.png}
            };
        \end{tikzpicture} 
    }
---
...
:::::::::: {.columns}
:::: {.column}
![](figures/fall3d_cites.png)
:::
::: {.column}
![](figures/fall3d_cites2.png)
:::
::::::::::
...
![](figures/fall3d-logo.png){ width=50% }

\vspace{1em}

![](figures/fall3d_git.png)

:::
::::::::::

## Scientific/technological transfer: FALL3D
![](figures/fall3d-users.pdf)
...
![](figures/fall3d_stats1.pdf)
![](figures/fall3d_stats2.pdf)
